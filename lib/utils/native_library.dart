...
class NativeLibrary {
  ...
  static Future<DynamicLibrary> load() async {
    if (Platform.isAndroid) {
      ...
      try {
        print("Trying to load from @executable_path/../Frameworks/${libraryName}");
        return DynamicLibrary.open("@executable_path/../Frameworks/${libraryName}");
      } catch (e) {
      ...
      throw Exception('Failed to initialize RCP service: Could not load native library: ${libraryName}.\n\n'
      ...
      throw Exception('Could not find native library: ${libraryName}. '
